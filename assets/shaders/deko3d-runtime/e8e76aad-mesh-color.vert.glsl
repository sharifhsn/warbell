...
void main() {
    VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX vertex_no_morph = VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX((uint(gl_InstanceID) + uint(gl_BaseInstanceARB)), _p2vs_location0, _p2vs_location7);
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX out_ = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX(vec4(0.0), vec4(0.0), 0.0, 0u, vec4(0.0));
    VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX vertex_1_ = VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX(0u, vec3(0.0), vec4(0.0));
    ...
    vec4 _e31_ = vertex_1_.color;
    out_.color = _e31_;
    out_.instance_index = vertex_no_morph.instance_index;
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBZGK4DBONZV62LPX _e34_ = out_;
    gl_Position = _e34_.position;
    _vs2fs_location4 = _e34_.world_position;
    _vs2fs_location6 = _e34_.unclipped_depth;
    _vs2fs_location7 = _e34_.instance_index;
    _vs2fs_location8 = _e34_.color;
    return;
}
