...
vec4 tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec4 in_1_, ColorGradingX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU5TJMV3QX in_color_grading) {
    ...
    color_2_ = _e15_;
    vec3 _e16_ = color_2_;
    float _e18_ = color_grading.post_saturation;
    vec3 _e19 = saturationX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e16_, _e18_);
    color_2_ = _e19;
    vec3 _e20_ = color_2_;
    return vec4(_e20_, in_1_.w);
}
...
void main() {
    ...
    output_rgb = _e9.xyz;
    vec3 _e11_ = output_rgb;
    _fs2p_location0 = vec4(_e11_, hdr_color.w);
    return;
}
