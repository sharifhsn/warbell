...
void main() {
    VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX vertex_no_morph = VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX((uint(gl_InstanceID) + uint(gl_BaseInstanceARB)), _p2vs_location0, _p2vs_location1, _p2vs_location2, _p2vs_location5);
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX out_ = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(vec4(0.0), vec4(0.0), vec3(0.0), vec2(0.0), vec4(0.0), 0u);
    VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX vertex_1_ = VertexX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(0u, vec3(0.0), vec3(0.0), vec2(0.0), vec4(0.0));
    ...
    out_.uv = _e25_;
    vec4 _e28_ = vertex_1_.color;
    out_.color = _e28_;
    out_.instance_index = vertex_no_morph.instance_index;
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX _e31_ = out_;
    gl_Position = _e31_.position;
    _vs2fs_location0 = _e31_.world_position;
    _vs2fs_location1 = _e31_.world_normal;
    _vs2fs_location2 = _e31_.uv;
    _vs2fs_location5 = _e31_.color;
    _vs2fs_location6 = _e31_.instance_index;
    return;
}
