...
PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_from_standard_materialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_3_, bool is_front_3_) {
    ...
    pbr_input_3_.material.base_color = (_e33_2 * base_color_3_);
...
void apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(inout PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_5_) {
    ...
    vec4 _e33_3 = emissive_1_;
    pbr_input_5_.material.emissive = _e33_3;
    vec3 _e35_2 = Nt;
    pbr_input_5_.N = normalize(_e35_2);
...
void main() {
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX vertex_output = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(gl_FragCoord, _vs2fs_location0, _vs2fs_location1, _vs2fs_location2, _vs2fs_location5, _vs2fs_location6);
    bool is_front = gl_FrontFacing;
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_ = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(vec4(0.0), vec4(0.0), vec3(0.0), vec2(0.0), vec4(0.0), 0u);
