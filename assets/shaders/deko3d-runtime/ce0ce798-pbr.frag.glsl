...
float sample_shadow_map_castano_thirteenX_naga_oil_mod_XMJSXM6K7OBRHEOR2ONUGCZDPO5PXGYLNOBWGS3THX(vec2 light_local_1_, float depth_1_, int array_index_1_) {
    ...
    vec2 uv_2_ = (light_local_1_ * shadow_map_size);
    base_uv = floor((uv_2_ + vec2(0.5)));
    float _e18_ = base_uv.x;
    float s = ((uv_2_.x + 0.5) - _e18_);
    float _e24_1 = base_uv.y;
    float t = ((uv_2_.y + 0.5) - _e24_1);
    vec2 _e26_ = base_uv;
...
vec3 sample_tony_mc_mapface_lutX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec3 stimulus) {
    ...
    vec3 _e11_2 = uv;
    vec3 _e13 = sample_current_lutX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(clamp(_e11_2, vec3(0.0), vec3(1.0)));
    return _e13.xyz;
}
...
vec4 tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec4 in_1_, ColorGradingX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU5TJMV3QX in_color_grading) {
    ...
    color_3_ = (_e8_5 * _e13);
    vec3 _e15_2 = color_3_;
    vec3 _e16 = sample_tony_mc_mapface_lutX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e15_2);
    color_3_ = _e16;
    vec3 _e17_1 = color_3_;
    float _e19_2 = color_grading.post_saturation;
    vec3 _e20 = saturationX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e17_1, _e19_2);
    color_3_ = _e20;
    vec3 _e21_1 = color_3_;
    return vec4(_e21_1, in_1_.w);
}
...
vec3 calculate_viewX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(vec4 world_position_1_, bool is_orthographic_3_) {
    ...
    if (is_orthographic_3_) {
        float _e5_1 = _group_0_binding_0_fs.clip_from_world[0][2];
        float _e10_2 = _group_0_binding_0_fs.clip_from_world[1][2];
        float _e15_4 = _group_0_binding_0_fs.clip_from_world[2][2];
        V_4_ = normalize(vec3(_e5_1, _e10_2, _e15_4));
    } else {
        vec3 _e22_1 = _group_0_binding_0_fs.world_position;
        V_4_ = normalize((_e22_1.xyz - world_position_1_.xyz));
    }
    vec3 _e27_3 = V_4_;
    return _e27_3;
}
...
PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_from_vertex_outputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_2_, bool is_front_2_, bool double_sided_1_) {
    ...
    bool _e20_6 = pbr_input_2_.is_orthographic;
    vec3 _e22 = calculate_viewX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(in_2_.world_position, _e20_6);
    pbr_input_2_.V = _e22;
...
PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_from_standard_materialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_3_, bool is_front_3_) {
    ...
    uv_1_ = (uv_transform * vec3(in_3_.uv, 1.0)).xy;
    vec2 _e60_3 = uv_1_;
    uv_b = _e60_3;
...
vec4 alpha_discardX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX material_1_, vec4 output_color_1_) {
    vec4 color_4_ = vec4(0.0);
    color_4_ = output_color_1_;
...
vec4 main_pass_post_lighting_processingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_4_, vec4 input_color_1_) {
    ...
    output_color_3_ = input_color_1_;
    vec4 _e2_2 = output_color_3_;
    ColorGradingX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU5TJMV3QX _e5_2 = _group_0_binding_0_fs.color_grading;
    vec4 _e8 = tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e2_2, _e5_2);
    output_color_3_ = _e8;
    vec4 _e7_3 = output_color_3_;
    ...
    vec3 _e19_3 = output_rgb;
    vec3 _e21 = powsafeX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU3LBORUHGX(_e19_3, 2.2);
    output_rgb = _e21;
    vec3 _e22_2 = output_rgb;
    float _e24_2 = output_color_3_.w;
    output_color_3_ = vec4(_e22_2, _e24_2);
    vec4 _e26_1 = output_color_3_;
    return _e26_1;
}
...
void apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(inout PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_5_) {
    ...
    vec4 _e11_3 = pbr_input_5_.material.base_color;
    base_color_2_ = _e11_3;
    vec4 _e15_5 = pbr_input_5_.material.emissive;
    emissive_1_ = _e15_5;
    vec3 _e18_6 = pbr_input_5_.N;
    Nt = _e18_6;
    float _e22_3 = pbr_input_5_.material.metallic;
    metallic_3_ = _e22_3;
    float _e26_2 = pbr_input_5_.material.perceptual_roughness;
    perceptual_roughness_3_ = _e26_2;
    vec4 _e30_2 = base_color_2_;
    pbr_input_5_.material.base_color = _e30_2;
    ...
    float _e42_1 = perceptual_roughness_3_;
    pbr_input_5_.material.perceptual_roughness = _e42_1;
    return;
}
...
void main() {
    ...
    pbr_input = _e6;
    StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e9_4 = pbr_input.material;
    vec4 _e12_2 = pbr_input.material.base_color;
    vec4 _e12 = alpha_discardX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e9_4, _e12_2);
    pbr_input.material.base_color = _e12;
    apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(pbr_input);
    uint _e16_4 = pbr_input.material.flags;
    if (((_e16_4 & STANDARD_MATERIAL_FLAGS_UNLIT_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX) == 0u)) {
        ...
        vec4 _e28_2 = pbr_input.material.base_color;
        out_.color = _e28_2;
    }
    PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e30_3 = pbr_input;
    vec4 _e32_3 = out_.color;
    vec4 _e32 = main_pass_post_lighting_processingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e30_3, _e32_3);
    out_.color = _e32;
    FragmentOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX _e34_ = out_;
    _fs2p_location0 = _e34_.color;
    return;
}
