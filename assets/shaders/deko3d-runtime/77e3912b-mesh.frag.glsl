...
const uint STANDARD_MATERIAL_FLAGS_FOG_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX = 256u;
...
const uint FOG_MODE_LINEARX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX = 1u;
const uint FOG_MODE_EXPONENTIALX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX = 2u;
const uint FOG_MODE_EXPONENTIAL_SQUAREDX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX = 3u;
const uint FOG_MODE_ATMOSPHERICX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX = 4u;
...
layout(std140, binding = 7) uniform type_21_block_0Fragment { MeshX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OR4XAZLTX _group_2_binding_0_fs[93]; };
...
layout(std140, binding = 6) uniform FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX_block_4Fragment { FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX _group_0_binding_13_fs; };

layout(std140, binding = 3) uniform ClusterableObjectIndexListsX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX_block_5Fragment { ClusterableObjectIndexListsX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX _group_0_binding_9_fs; };

layout(std140, binding = 4) uniform ClusterOffsetsAndCountsX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX_block_6Fragment { ClusterOffsetsAndCountsX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX _group_0_binding_10_fs; };
...
layout(std140, binding = 5) uniform GlobalsX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DUZ3MN5RGC3DTX_block_7Fragment { GlobalsX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DUZ3MN5RGC3DTX _group_0_binding_11_fs; };

layout(binding = 2) uniform sampler3D _group_0_binding_18_fs;

layout(std140, binding = 8) uniform StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX_block_8Fragment { StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _group_3_binding_0_fs; };
...
mat3x3 orthonormalizeX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU3LBORUHGX(vec3 z_basis) {
    ...
    float a_2_ = (-1.0 / (_e3 + z_basis.z));
    float b_1_ = ((z_basis.x * z_basis.y) * a_2_);
    vec3 x_basis_2_ = vec3((1.0 + (((_e3 * z_basis.x) * z_basis.x) * a_2_)), (_e3 * b_1_), (-(_e3) * z_basis.x));
    vec3 y_basis_2_ = vec3(b_1_, (_e3 + ((z_basis.y * z_basis.y) * a_2_)), -(z_basis.y));
...
vec4 compute_specular_layer_values_for_point_lightX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(inout LightingInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX input_, uint layer, vec3 V, vec3 light_to_frag, float light_radius, float distance_) {
    ...
    float a_3_ = input_.layers[layer].roughness;
    ...
    float a_prime = clamp((a_3_ + (light_radius / (2.0 * distance_))), 0.0, 1.0);
...
float D_GGXX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(float roughness, float NdotH) {
    ...
    float a_4_ = (NdotH * roughness);
    float k = (roughness / (oneMinusNdotHSquared + (a_4_ * a_4_)));
...
vec3 point_lightX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(uint light_id, inout LightingInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX input_4_, bool enable_diffuse, bool enable_texture) {
    ...
    float distance_5_ = sqrt(distance_square);
    ...
    float a_5_ = input_4_.layers[0].roughness;
    float _e35_ = _group_0_binding_8_fs.data[light_id].position_radius.w;
    vec4 _e45 = compute_specular_layer_values_for_point_lightX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(input_4_, LAYER_BASEX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX, V_5_, light_to_frag_1_, _e35_, distance_5_);
    ...
    float normalizationFactor = (a_5_ / a_prime_1_);
    float specular_intensity_2_ = (normalizationFactor * normalizationFactor);
    float _e51 = specular_fix_remapX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(a_5_);
    float brdf_roughness = mix(a_5_, a_prime_1_, _e51);
    ...
    if ((light_radius_1_ > 0.0)) {
        float solid_angle = ((light_radius_1_ * light_radius_1_) / (distance_5_ * distance_5_));
...
vec4 world_to_directional_light_localX_naga_oil_mod_XMJSXM6K7OBRHEOR2ONUGCZDPO5ZQX(uint light_id_15_, uint cascade_index, vec4 offset_position) {
    ...
    if (!(any(lessThan(offset_position_ndc.xy, vec2(-1.0))))) {
        local = (offset_position_ndc.z < 0.0);
    } else {
        local = true;
    }
    bool _e32_1 = local;
    if (!(_e32_1)) {
        local_1_ = any(greaterThan(offset_position_ndc, vec3(1.0)));
    } else {
        local_1_ = true;
    }
    bool _e41_ = local_1_;
...
vec3 position_world_to_viewX_naga_oil_mod_XMJSXM6K7OBRHEOR2OZUWK527ORZGC3TTMZXXE3LBORUW63TTX(vec3 world_pos) {
    mat4x4 _e2_2 = _group_0_binding_0_fs.view_from_world;
    vec4 view_pos = (_e2_2 * vec4(world_pos, 1.0));
    return view_pos.xyz;
}

vec4 scattering_adjusted_fog_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params, vec3 scattering) {
    if ((fog_params.directional_light_color.w > 0.0)) {
        return vec4((fog_params.base_color.xyz + ((scattering * fog_params.directional_light_color.xyz) * fog_params.directional_light_color.w)), fog_params.base_color.w);
    } else {
        return fog_params.base_color;
    }
}

vec4 linear_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params_1_, vec4 input_color_1_, float distance_1_, vec3 scattering_1_) {
    vec4 fog_color = vec4(0.0);
    vec4 _e5 = scattering_adjusted_fog_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_1_, scattering_1_);
    fog_color = _e5;
    float start = fog_params_1_.be.x;
    float end = fog_params_1_.be.y;
    float _e9_3 = fog_color.w;
    fog_color.w = (_e9_3 * (1.0 - clamp(((end - distance_1_) / (end - start)), 0.0, 1.0)));
    vec4 _e22_1 = fog_color;
    float _e25_2 = fog_color.w;
    return vec4(mix(input_color_1_.xyz, _e22_1.xyz, _e25_2), input_color_1_.w);
}

vec4 exponential_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params_2_, vec4 input_color_2_, float distance_2_, vec3 scattering_2_) {
    vec4 fog_color_1_ = vec4(0.0);
    vec4 _e5 = scattering_adjusted_fog_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_2_, scattering_2_);
    fog_color_1_ = _e5;
    float density = fog_params_2_.be.x;
    float _e7_2 = fog_color_1_.w;
    fog_color_1_.w = (_e7_2 * (1.0 - (1.0 / exp((distance_2_ * density)))));
    vec4 _e18_6 = fog_color_1_;
    float _e21_1 = fog_color_1_.w;
    return vec4(mix(input_color_2_.xyz, _e18_6.xyz, _e21_1), input_color_2_.w);
}

vec4 exponential_squared_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params_3_, vec4 input_color_3_, float distance_3_, vec3 scattering_3_) {
    vec4 fog_color_2_ = vec4(0.0);
    vec4 _e5 = scattering_adjusted_fog_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_3_, scattering_3_);
    fog_color_2_ = _e5;
    float distance_times_density = (distance_3_ * fog_params_3_.be.x);
    float _e9_4 = fog_color_2_.w;
    fog_color_2_.w = (_e9_4 * (1.0 - (1.0 / exp((distance_times_density * distance_times_density)))));
    vec4 _e19_2 = fog_color_2_;
    float _e22_2 = fog_color_2_.w;
    return vec4(mix(input_color_3_.xyz, _e19_2.xyz, _e22_2), input_color_3_.w);
}

vec4 atmospheric_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params_4_, vec4 input_color_4_, float distance_4_, vec3 scattering_4_) {
    vec4 fog_color_3_ = vec4(0.0);
    vec4 _e5 = scattering_adjusted_fog_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_4_, scattering_4_);
    fog_color_3_ = _e5;
    vec3 extinction_factor = (vec3(1.0) - (vec3(1.0) / exp((distance_4_ * fog_params_4_.be))));
    vec3 inscattering_factor = (vec3(1.0) - (vec3(1.0) / exp((distance_4_ * fog_params_4_.bi))));
    float _e26_1 = fog_color_3_.w;
    vec4 _e32_3 = fog_color_3_;
    float _e36_2 = fog_color_3_.w;
    return vec4(((input_color_4_.xyz * (vec3(1.0) - (extinction_factor * _e26_1))) + ((_e32_3.xyz * inscattering_factor) * _e36_2)), input_color_4_.w);
}
...
vec3 convertOpenDomainToNormalizedLog2_X_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec3 color_2_, float minimum_ev, float maximum_ev) {
    ...
    vec3 _e18_7 = normalized_color;
    normalized_color = clamp(log2((_e18_7 / vec3(0.18))), vec3(minimum_ev), vec3(maximum_ev));
    float total_exposure = (maximum_ev - minimum_ev);
    vec3 _e26_2 = normalized_color;
    return ((_e26_2 - vec3(minimum_ev)) / vec3(total_exposure));
}
...
vec3 applyAgXLogX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec3 Image) {
    ...
    float b_2_ = dot(_e17_1, vec3(0.04237565, 0.0784336, 0.879143));
    prepared_image = vec3(r_1_, g, b_2_);
...
vec4 tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(vec4 in_1_, ColorGradingX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU5TJMV3QX in_color_grading) {
    ...
    float _e22_3 = color_grading.post_saturation;
    vec3 _e23 = saturationX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e20_6, _e22_3);
    color_4_ = _e23;
...
vec3 prepare_world_normalX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(vec3 world_normal_1_, bool double_sided, bool is_front_1_) {
    ...
    if (!(!(double_sided))) {
        local_2_ = is_front_1_;
    } else {
        local_2_ = true;
    }
    bool _e9_5 = local_2_;
    vec3 _e15_3 = output_;
    output_ = (((float(_e9_5) * 2.0) - 1.0) * _e15_3);
    vec3 _e17_3 = output_;
    return _e17_3;
}
...
vec3 calculate_viewX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(vec4 world_position_1_, bool is_orthographic_3_) {
    ...
    if (is_orthographic_3_) {
        ...
        vec3 _e22_4 = _group_0_binding_0_fs.world_position;
        V_4_ = normalize((_e22_4.xyz - world_position_1_.xyz));
    }
    vec3 _e27_3 = V_4_;
    return _e27_3;
}
...
PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_from_vertex_outputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_2_, bool is_front_2_, bool double_sided_1_) {
    ...
    vec3 _e29 = prepare_world_normalX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(in_2_.world_normal, double_sided_1_, is_front_2_);
    pbr_input_2_.world_normal = _e29;
    vec3 _e33_2 = pbr_input_2_.world_normal;
    pbr_input_2_.N = normalize(_e33_2);
    PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e35_2 = pbr_input_2_;
    return _e35_2;
}
...
PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_from_standard_materialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_3_, bool is_front_3_) {
    ...
    uint _e7_3 = _group_2_binding_0_fs[in_3_.instance_index].material_and_lightmap_bind_group_slot;
    uint slot = (_e7_3 & 65535u);
    uint flags = _group_3_binding_0_fs.flags;
    vec4 base_color_3_ = _group_3_binding_0_fs.base_color;
    ...
    vec4 _e33_3 = pbr_input_3_.material.base_color;
    pbr_input_3_.material.base_color = (_e33_3 * base_color_3_);
    pbr_input_3_.material.deferred_lighting_pass_id = deferred_lighting_pass_id;
    vec3 _e38_3 = pbr_input_3_.N;
    vec3 _e40_ = pbr_input_3_.V;
    float NdotV_6_ = max(dot(_e38_3, _e40_), 0.0001);
...
vec4 alpha_discardX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX material_1_, vec4 output_color_1_) {
    vec4 color_5_ = vec4(0.0);
    color_5_ = output_color_1_;
    uint alpha_mode = (material_1_.flags & STANDARD_MATERIAL_FLAGS_ALPHA_MODE_RESERVED_BITSX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX);
    if ((alpha_mode == STANDARD_MATERIAL_FLAGS_ALPHA_MODE_OPAQUEX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX)) {
        color_5_.w = 1.0;
    }
    vec4 _e10_4 = color_5_;
    return _e10_4;
}
...
vec4 apply_pbr_lightingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX in_4_) {
    ...
    output_color_2_ = in_4_.material.base_color;
    vec4 emissive_2_ = in_4_.material.emissive;
    float metallic_4_ = in_4_.material.metallic;
    float perceptual_roughness_4_ = in_4_.material.perceptual_roughness;
    float _e36 = perceptualRoughnessToRoughnessX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(perceptual_roughness_4_);
    ...
    vec4 _e40_1 = output_color_2_;
    vec3 _e64 = calculate_diffuse_colorX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e40_1.xyz, metallic_4_, specular_transmission_2_, diffuse_transmission_2_);
    vec4 _e43_3 = output_color_2_;
    vec3 diffuse_transmissive_color = (((_e43_3.xyz * (1.0 - metallic_4_)) * (1.0 - specular_transmission_2_)) * diffuse_transmission_2_);
    vec4 diffuse_transmissive_lobe_world_position = (in_4_.world_position - (vec4(in_4_.world_normal, 0.0) * thickness_1_));
    vec4 _e58_5 = output_color_2_;
    vec3 _e82 = calculate_F0X_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e58_5.xyz, metallic_4_, reflectance_2_);
    vec2 _e83 = F_ABX_naga_oil_mod_XMJSXM6K7OBRHEOR2NRUWO2DUNFXGOX(perceptual_roughness_4_, NdotV_7_);
    lighting_input.layers[0].NdotV = NdotV_7_;
    lighting_input.layers[0].N = in_4_.N;
    lighting_input.layers[0].R = R_1_;
    lighting_input.layers[0].perceptual_roughness = perceptual_roughness_4_;
    ...
    lighting_input.metallic = metallic_4_;
    ...
    while(true) {
        ...
        }
        {
            ...
            if (((in_4_.flags & MESH_FLAGS_SHADOW_RECEIVER_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OR4XAZLTX) != 0u)) {
                ...
                local_3_ = ((_e141_ & POINT_LIGHT_FLAGS_SHADOWS_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX) != 0u);
            } else {
                local_3_ = false;
            }
            bool _e149_1 = local_3_;
            if (_e149_1) {
    ...
    while(true) {
        ...
        }
        {
            ...
            if (((in_4_.flags & MESH_FLAGS_SHADOW_RECEIVER_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OR4XAZLTX) != 0u)) {
                ...
                local_4_ = ((_e186_ & POINT_LIGHT_FLAGS_SHADOWS_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX) != 0u);
            } else {
                local_4_ = false;
            }
            bool _e194_ = local_4_;
            if (_e194_) {
    ...
    while(true) {
        ...
        }
        {
            ...
            if (((in_4_.flags & MESH_FLAGS_SHADOW_RECEIVER_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OR4XAZLTX) != 0u)) {
                ...
                local_5_ = ((_e236_ & DIRECTIONAL_LIGHT_FLAGS_SHADOWS_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX) != 0u);
            } else {
                local_5_ = false;
            }
            bool _e244_ = local_5_;
            if (_e244_) {
                uint _e245_ = i_3_;
    ...
    if (true) {
        ...
        vec3 _e274 = ambient_lightX_naga_oil_mod_XMJSXM6K7OBRHEOR2MFWWE2LFNZ2AX(in_4_.world_position, in_4_.N, in_4_.V, NdotV_7_, _e64, _e82, perceptual_roughness_4_, diffuse_occlusion_1_);
        indirect_light = (_e265_ + _e274);
    }
    float _e273_ = output_color_2_.w;
    emissive_light = (emissive_2_.xyz * _e273_);
    vec3 _e276_ = emissive_light;
    float _e279_ = _group_0_binding_0_fs.exposure;
    emissive_light = (_e276_ * mix(1.0, _e279_, emissive_2_.w));
    ...
    float _e297_ = output_color_2_.w;
    output_color_2_ = vec4(((_e287_ * ((_e288_ + _e289_) + _e291_)) + _e294_), _e297_);
    vec4 _e299_ = output_color_2_;
    ...
    output_color_2_ = _e305;
    vec4 _e303_ = output_color_2_;
    return _e303_;
}

vec4 apply_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX fog_params_5_, vec4 input_color_5_, vec3 fragment_world_position, vec3 view_world_position, vec2 frag_coord_xy_10_) {
    vec3 scattering_5_ = vec3(0.0);
    uint i_4_ = 0u;
    float shadow_4_ = 0.0;
    vec3 view_to_world = (fragment_world_position.xyz - view_world_position.xyz);
    float distance_6_ = length(view_to_world);
    vec3 _e15 = position_world_to_viewX_naga_oil_mod_XMJSXM6K7OBRHEOR2OZUWK527ORZGC3TTMZXXE3LBORUW63TTX(fragment_world_position);
    float view_z_6_ = _e15.z;
    vec3 view_direction_normal = normalize(-(view_to_world));
    vec4 fragment_world_position_vec4_ = vec4(fragment_world_position, 1.0);
    if ((fog_params_5_.directional_light_color.w > 0.0)) {
        vec3 view_to_world_normalized = (view_to_world / vec3(distance_6_));
        uint n_directional_lights_1_ = _group_0_binding_1_fs.n_directional_lights;
        ...
        while(true) {
            ...
            loop_init_4 = false;
            uint _e26_3 = i_4_;
            if ((_e26_3 < n_directional_lights_1_)) {
            } else {
                break;
            }
            {
                uint _e30_2 = i_4_;
                DirectionalLightX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX light_10_ = _group_0_binding_1_fs.directional_lights[_e30_2];
                float _e44_5 = _group_0_binding_0_fs.exposure;
                vec3 scattering_contribution = ((pow(max(dot(view_to_world_normalized, light_10_.direction_to_light), 0.0), fog_params_5_.directional_light_exponent) * light_10_.color.xyz) * _e44_5);
                shadow_4_ = 1.0;
                if (((light_10_.flags & DIRECTIONAL_LIGHT_FLAGS_SHADOWS_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX) != 0u)) {
                    uint _e53_ = i_4_;
                    float _e57 = fetch_directional_shadowX_naga_oil_mod_XMJSXM6K7OBRHEOR2ONUGCZDPO5ZQX(_e53_, fragment_world_position_vec4_, view_direction_normal, view_z_6_, frag_coord_xy_10_);
                    shadow_4_ = _e57;
                }
                vec3 _e57_ = scattering_5_;
                float _e58_6 = shadow_4_;
                scattering_5_ = (_e57_ + (scattering_contribution * _e58_6));
            }
        }
    }
    if ((fog_params_5_.mode == FOG_MODE_LINEARX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX)) {
        vec3 _e67_1 = scattering_5_;
        vec4 _e69 = linear_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_5_, input_color_5_, distance_6_, _e67_1);
        return _e69;
    } else {
        if ((fog_params_5_.mode == FOG_MODE_EXPONENTIALX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX)) {
            vec3 _e73_2 = scattering_5_;
            vec4 _e74 = exponential_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_5_, input_color_5_, distance_6_, _e73_2);
            return _e74;
        } else {
            if ((fog_params_5_.mode == FOG_MODE_EXPONENTIAL_SQUAREDX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX)) {
                vec3 _e78_ = scattering_5_;
                vec4 _e79 = exponential_squared_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_5_, input_color_5_, distance_6_, _e78_);
                return _e79;
            } else {
                if ((fog_params_5_.mode == FOG_MODE_ATMOSPHERICX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX)) {
                    vec3 _e83_1 = scattering_5_;
                    vec4 _e84 = atmospheric_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXWOX(fog_params_5_, input_color_5_, distance_6_, _e83_1);
                    return _e84;
                } else {
                    return input_color_5_;
                }
            }
        }
    }
...
vec4 main_pass_post_lighting_processingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_4_, vec4 input_color_6_) {
    vec4 output_color_3_ = vec4(0.0);
    vec3 output_rgb = vec3(0.0);
    output_color_3_ = input_color_6_;
    if (((pbr_input_4_.material.flags & STANDARD_MATERIAL_FLAGS_FOG_ENABLED_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX) != 0u)) {
        FogX_naga_oil_mod_XMJSXM6K7OBRHEOR2NVSXG2C7OZUWK527OR4XAZLTX _e10_5 = _group_0_binding_13_fs;
        vec4 _e11_3 = output_color_3_;
        vec3 _e16_4 = _group_0_binding_0_fs.world_position;
        vec4 _e21 = apply_fogX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e10_5, _e11_3, pbr_input_4_.world_position.xyz, _e16_4.xyz, pbr_input_4_.frag_coord.xy);
        output_color_3_ = _e21;
    }
    vec4 _e21_2 = output_color_3_;
    ColorGradingX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU5TJMV3QX _e24_4 = _group_0_binding_0_fs.color_grading;
    vec4 _e26 = tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e21_2, _e24_4);
    output_color_3_ = _e26;
    vec4 _e26_4 = output_color_3_;
    output_rgb = _e26_4.xyz;
    vec3 _e29_2 = output_rgb;
    vec3 _e31 = powsafeX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU3LBORUHGX(_e29_2, 0.45454547);
    output_rgb = _e31;
    vec3 _e32_4 = output_rgb;
    vec3 _e35 = screen_space_ditherX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(pbr_input_4_.frag_coord.xy);
    output_rgb = (_e32_4 + _e35);
    vec3 _e37_1 = output_rgb;
    vec3 _e39 = powsafeX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU3LBORUHGX(_e37_1, 2.2);
    output_rgb = _e39;
    vec3 _e40_2 = output_rgb;
    float _e42_1 = output_color_3_.w;
    output_color_3_ = vec4(_e40_2, _e42_1);
    vec4 _e44_6 = output_color_3_;
    return _e44_6;
}

void apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(inout PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_5_) {
    vec4 base_color_2_ = vec4(0.0);
    vec4 emissive_1_ = vec4(0.0);
    vec3 Nt = vec3(0.0);
    float metallic_3_ = 0.0;
    float perceptual_roughness_3_ = 0.0;
    vec4 _e2_3 = pbr_input_5_.world_position;
    vec3 world_position_2_ = _e2_3.xyz;
    vec3 world_normal_2_ = pbr_input_5_.world_normal;
    vec4 _e7_4 = pbr_input_5_.frag_coord;
    vec2 frag_coord_2_ = _e7_4.xy;
    vec4 _e11_4 = pbr_input_5_.material.base_color;
    base_color_2_ = _e11_4;
    vec4 _e15_5 = pbr_input_5_.material.emissive;
    emissive_1_ = _e15_5;
    vec3 _e18_8 = pbr_input_5_.N;
    Nt = _e18_8;
    float _e22_5 = pbr_input_5_.material.metallic;
    metallic_3_ = _e22_5;
    float _e26_5 = pbr_input_5_.material.perceptual_roughness;
    perceptual_roughness_3_ = _e26_5;
    vec4 _e30_3 = base_color_2_;
    pbr_input_5_.material.base_color = _e30_3;
    vec4 _e33_4 = emissive_1_;
    pbr_input_5_.material.emissive = _e33_4;
    vec3 _e35_3 = Nt;
    pbr_input_5_.N = normalize(_e35_3);
    float _e39_2 = metallic_3_;
    pbr_input_5_.material.metallic = _e39_2;
    float _e42_2 = perceptual_roughness_3_;
    pbr_input_5_.material.perceptual_roughness = _e42_2;
    return;
}

void main() {
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX vertex_output = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(gl_FragCoord, _vs2fs_location0, _vs2fs_location1, _vs2fs_location2, _vs2fs_location6);
    bool is_front = gl_FrontFacing;
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX in_ = VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX(vec4(0.0), vec4(0.0), vec3(0.0), vec2(0.0), 0u);
    ...
    in_ = vertex_output;
    VertexOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX _e2_4 = in_;
    PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e6 = pbr_input_from_standard_materialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOJQWO3LFNZ2AX(_e2_4, is_front);
    pbr_input = _e6;
    StandardMaterialX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e9_6 = pbr_input.material;
    vec4 _e12_2 = pbr_input.material.base_color;
    vec4 _e12 = alpha_discardX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e9_6, _e12_2);
    pbr_input.material.base_color = _e12;
    apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(pbr_input);
    uint _e16_5 = pbr_input.material.flags;
    if (((_e16_5 & STANDARD_MATERIAL_FLAGS_UNLIT_BITX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX) == 0u)) {
        PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e23_4 = pbr_input;
        vec4 _e23 = apply_pbr_lightingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e23_4);
        out_.color = _e23;
    } else {
        vec4 _e28_3 = pbr_input.material.base_color;
        out_.color = _e28_3;
    }
    PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX _e30_4 = pbr_input;
    vec4 _e32_5 = out_.color;
    vec4 _e32 = main_pass_post_lighting_processingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(_e30_4, _e32_5);
    out_.color = _e32;
    FragmentOutputX_naga_oil_mod_XMJSXM6K7OBRHEOR2MZXXE53BOJSF62LPX _e34_1 = out_;
    _fs2p_location0 = _e34_1.color;
    return;
}
