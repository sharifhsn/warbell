...
vec4 main_pass_post_lighting_processingX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3GOVXGG5DJN5XHGX(PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_4_, vec4 input_color_1_) {
    ...
    vec4 _e8 = tone_mappingX_naga_oil_mod_XMJSXM6K7MNXXEZK7OBUXAZLMNFXGKOR2ORXW4ZLNMFYHA2LOM4X(_e2_2, _e5_4);
    output_color_3_ = _e8;
    vec4 _e7_3 = output_color_3_;
    output_rgb = _e7_3.xyz;
    vec3 _e10_5 = output_rgb;
    vec3 _e13 = powsafeX_naga_oil_mod_XMJSXM6K7OJSW4ZDFOI5DU3LBORUHGX(_e10_5, 0.45454547);
    output_rgb = _e13;
    ...
    float _e24_4 = output_color_3_.w;
    output_color_3_ = vec4(_e22_3, _e24_4);
    vec4 _e26_2 = output_color_3_;
    return _e26_2;
}
...
void apply_decalsX_naga_oil_mod_XMJSXM6K7OBRHEOR2MRSWGYLMHI5GG3DVON2GK4TFMQX(inout PbrInputX_naga_oil_mod_XMJSXM6K7OBRHEOR2OBRHEX3UPFYGK4YX pbr_input_5_) {
    ...
    emissive_1_ = _e15_5;
    vec3 _e18_7 = pbr_input_5_.N;
    Nt = _e18_7;
    float _e22_4 = pbr_input_5_.material.metallic;
    metallic_3_ = _e22_4;
    float _e26_3 = pbr_input_5_.material.perceptual_roughness;
    perceptual_roughness_3_ = _e26_3;
